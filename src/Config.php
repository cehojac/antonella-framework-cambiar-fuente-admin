...
class Config
{
    ...
    * @example ['post_data'=>'CFA::function']
    */
    public $post=[
    ...
    * @example ['get_data'=>'CFA::function']
    */
    public $get=[];
    /**
    * add_filter data functions
    * @input array
    * @example ['body_class','CFA::function',10,2]
    * @example ['body_class',['CFA','function'],10,2]
    */
    public $add_filter=[];
    /**
    ...
    * @input array
    * @example [['example','CFA\ExampleController::example_shortcode']]
    */
    public $shortcodes=[
        ['example','CFA\ExampleController::example_shortcode']
    ];
    /**
    * Dashboard
